  ...
  return <main style={{ minHeight: "100vh", background: "#f6f8fc", padding: "24px" }}>
    <div style={{ maxWidth: 1800, margin: "0 auto" }}>
      <header style={{ marginBottom: 18, display: "flex", justifyContent: "space-between", gap: 16, alignItems: "center", flexWrap: "wrap" }}>
        ...
        <a href="/" style={{ border: "1px solid #cbd5e1", borderRadius: 10, padding: "10px 14px", textDecoration: "none", color: "#0f172a", background: "white", fontWeight: 700 }}>Learning dashboard</a>
      </header>
      <PaperLedger />
    </div>
  </main>;
