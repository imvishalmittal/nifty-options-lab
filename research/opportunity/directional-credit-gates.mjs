...
export function evaluateDirectionalCreditGates(document) {
...
function main() {
  ...
  const report = evaluateDirectionalCreditGates(JSON.parse(fs.readFileSync(args.in, 'utf8')));
...
if (process.argv[1]?.endsWith('directional-credit-gates.mjs')) {
