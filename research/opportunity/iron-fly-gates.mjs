...
export function evaluateIronFlyGates(document) {
...
function main() {
  ...
  const report = evaluateIronFlyGates(JSON.parse(fs.readFileSync(args.in, 'utf8')));
...
if (process.argv[1]?.endsWith('iron-fly-gates.mjs')) {
