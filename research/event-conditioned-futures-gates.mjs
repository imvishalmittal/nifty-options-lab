...
export function evaluateEventFutures(result) {
  ...
  return { decision: Object.values(checks).every(Boolean) ? 'PASS_DISCOVERY' : 'REJECT_DISCOVERY', checks, normal: normal.performance, stress: stress.performance, severe: severe.performance };
}
